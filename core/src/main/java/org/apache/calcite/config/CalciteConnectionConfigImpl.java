...
public class CalciteConnectionConfigImpl extends ConnectionConfigImpl
  ...
  @Override
  public String fixedOptimizer() {
    return CalciteConnectionProperty.FIXED_OPTIMIZER.wrap(properties)
            .getString();
  }

  @Override
  public int dqnThreshold() {
    return CalciteConnectionProperty.DQN_THRESHOLD.wrap(properties)
            .getInt();
  }
