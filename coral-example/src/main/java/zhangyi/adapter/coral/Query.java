...
//            "and s.s_suppkey < 400 ";
//    public static final String Q1 = "SELECT count(o_custkey) FROM clickhouse.orders as o " +
//            "join postgres.customer as c on o.o_custkey = c.c_custkey " +
//            "join memsql.supplier as s on s.s_nationkey = c.c_nationkey " +
...
//            "group by o.o_custkey";
    public static final String Q1 = "SELECT n.n_name, s.s_suppkey, l.l_orderkey FROM postgres.nation as n \n" +
            ...
            "and s.s_suppkey < 5000 \n";
    public static final String Q2 = "SELECT c_custkey, c_nationkey, o_orderkey, p_partkey, p_name FROM clickhouse.lineitem as l \n" +
            "join clickhouse.orders as o on o.o_orderkey = l.l_orderkey \n" +
            "join memsql.part as p on p.p_partkey = l.l_partkey \n" +
            "join postgres.customer as c on o.o_custkey = c.c_custkey \n" +
            "where c.c_nationkey = 5 \n" +
            "and p.p_partkey = 1000 " +
            "and l.l_discount = 0 ";
    public static final String Q3 = "SELECT c_custkey, c_nationkey, o_orderkey, p_partkey, p_name FROM clickhouse.lineitem as l \n" +
            "join clickhouse.orders as o on l.l_orderkey = o.o_orderkey \n" +
            "join memsql.part as p on p.p_partkey = l.l_partkey \n" +
            "join postgres.customer as c on o.o_custkey = c.c_custkey \n" +
    ...
    // join number 1
    public static final String Q13 = "SELECT count(1),l_discount FROM clickhouse.lineitem as l " +
            "group by l.l_discount";
    // join number 2
