...
//                            CoralTest.class.getResource("/model-10G.json"))
...
//                .with(CalciteConnectionProperty.HEURISTIC_THRESHOLD, 100)
    ...
    @Test
    public void test(){
        execute("SELECT count(1) FROM clickhouse.orders as o " +
